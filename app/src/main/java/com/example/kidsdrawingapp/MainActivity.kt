...
//                        val myBitmap: Bitmap = getBitmapFromView(binding.flDrawingViewContainer)
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        val bindingDialog: DialogBrushSizeBinding = DialogBrushSizeBinding.inflate(layoutInflater)
    ...
    private fun showRationaleDialog(
        ...
        builder.setTitle("Kids Drawing App")
            .setMessage("Kids Drawing App needs to Access Your External Storage")
